package exponential_pkg_scrap;
	...
	const logic [LAMP_FLOAT_COR_DW-1:0] X0 = {X0_ext[31:23], FUNC_COR_rndToNearestEven({1'b0, 1'b1, X0_ext[22:22-LAMP_FLOAT_COR_F_DW-1], | X0_ext[22-LAMP_FLOAT_COR_F_DW-2:0]})}; //25'b0__0111_1111__0011_0100_1000_0100;
	const logic [LAMP_FLOAT_COR_DW-1:0] Y0 = {LAMP_FLOAT_COR_DW{1'b0}}; //25'b0__0000_0000__0000_0000_0000_0000;
	const logic [LAMP_FLOAT_COR_DW-1:0] Z0 = {LAMP_FLOAT_COR_DW{1'b0}}; //25'b0__0000_0000__0000_0000_0000_0000;
	const logic 						D0 = 1'b0;

	parameter INF_COR_E_F  = {8'b1, {LAMP_FLOAT_COR_F_DW{1'b0}}};			//24'b111111110000000000000000;
	parameter SNAN_COR_E_F = {8'b1, 1'b0, {LAMP_FLOAT_COR_F_DW-1{1'b1}}};	//24'b111111110111111111111111;
	parameter QNAN_COR_E_F = {9'b1, {LAMP_FLOAT_COR_F_DW-1{1'b0}}};			//24'b111111111000000000000000;
	parameter ZERO_COR_E_F = {LAMP_FLOAT_COR_DW-1{1'b0}};					//24'b000000000000000000000000;

	//////////////////////////////////////////////////
	//					  taylor		            //
	//////////////////////////////////////////////////

	parameter LAMP_FLOAT_TAY_DW	  = 16;
	parameter LAMP_FLOAT_TAY_S_DW = 1;
	parameter LAMP_FLOAT_TAY_E_DW = 8;
	parameter LAMP_FLOAT_TAY_F_DW = 7;

	parameter TAYLOR_APPROX		  = 4;

	const logic [LAMP_FLOAT_DW-1:0] ONE_CONST = {1'b0, 8'd127, {LAMP_FLOAT_TAY_F_DW{1'b0}}}; //16'b0_0111_1111_0000_000;
