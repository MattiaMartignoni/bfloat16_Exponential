...
input			[LAMP_FLOAT_COR_DW-1:0]		op1_i;
input			[LAMP_FLOAT_COR_DW-1:0]		op2_i;

output	logic	[LAMP_FLOAT_COR_DW-1:0]	result_o;
...
// OUTPUT wires: to drive registered output
	logic	[LAMP_FLOAT_COR_DW-1:0]			result_o_next;
	logic									isResultValid_o_next;

	//	mul outputs
	logic									mul_s_res;
	logic	[LAMP_FLOAT_COR_E_DW-1:0]			mul_e_res;
	logic	[LAMP_FLOAT_COR_F_DW+5-1:0]			mul_f_res;
	logic									mul_valid;
	...
	logic	[LAMP_FLOAT_COR_DW-1:0]			res;
	logic									isResValid;

	//	op1
	logic	[LAMP_FLOAT_COR_S_DW-1:0] 			s_op1_r;
	logic	[LAMP_FLOAT_COR_E_DW-1:0] 			e_op1_r;
	logic	[LAMP_FLOAT_COR_F_DW-1:0] 			f_op1_r;
	logic	[(LAMP_FLOAT_COR_F_DW+1)-1:0] 		extF_op1_r;
	logic	[(LAMP_FLOAT_COR_E_DW+1)-1:0] 		extE_op1_r;
	logic									isInf_op1_r;
	logic									isZ_op1_r;
	logic									isSNAN_op1_r;
	logic									isQNAN_op1_r;
	...
	logic	[LAMP_FLOAT_COR_E_DW-1:0] 			e_op2_r;
	logic	[LAMP_FLOAT_COR_F_DW-1:0] 			f_op2_r;
	logic	[(LAMP_FLOAT_COR_F_DW+1)-1:0] 		extF_op2_r;
	logic	[(LAMP_FLOAT_COR_E_DW+1)-1:0] 		extE_op2_r;
	logic									isInf_op2_r;
	logic									isZ_op2_r;
	logic									isSNAN_op2_r;
	logic									isQNAN_op2_r;
	//	mul/div only
	logic	[(1+LAMP_FLOAT_COR_F_DW)-1:0] 		extShF_op1_r;
	logic	[$clog2(1+LAMP_FLOAT_COR_F_DW)-1:0]	nlz_op1_r;
	logic	[(1+LAMP_FLOAT_COR_F_DW)-1:0] 		extShF_op2_r;
	logic	[$clog2(1+LAMP_FLOAT_COR_F_DW)-1:0]	nlz_op2_r;

	//	pre-operation wires/regs
	//	op1
	logic	[LAMP_FLOAT_COR_S_DW-1:0] 			s_op1_wire;
	logic	[LAMP_FLOAT_COR_E_DW-1:0] 			e_op1_wire;
	logic	[LAMP_FLOAT_COR_F_DW-1:0] 			f_op1_wire;
	logic	[(LAMP_FLOAT_COR_F_DW+1)-1:0] 		extF_op1_wire;
	logic	[(LAMP_FLOAT_COR_E_DW+1)-1:0] 		extE_op1_wire;
	logic									isDN_op1_wire;
	logic									isZ_op1_wire;
	...
	//	op2
	logic	[LAMP_FLOAT_COR_S_DW-1:0] 			s_op2_wire;
	logic	[LAMP_FLOAT_COR_E_DW-1:0] 			e_op2_wire;
	logic	[LAMP_FLOAT_COR_F_DW-1:0] 			f_op2_wire;
	logic	[(LAMP_FLOAT_COR_F_DW+1)-1:0] 		extF_op2_wire;
	logic	[(LAMP_FLOAT_COR_E_DW+1)-1:0] 		extE_op2_wire;
	logic									isDN_op2_wire;
	logic									isZ_op2_wire;
	...
	//	mul/div only
	logic	[(1+LAMP_FLOAT_COR_F_DW)-1:0] 		extShF_op1_wire;
	logic	[$clog2(1+LAMP_FLOAT_COR_F_DW)-1:0]	nlz_op1_wire;
	logic	[(1+LAMP_FLOAT_COR_F_DW)-1:0] 		extShF_op2_wire;
	logic	[$clog2(1+LAMP_FLOAT_COR_F_DW)-1:0]	nlz_op2_wire;
	...
	logic									s_res_postRnd;
	logic	[LAMP_FLOAT_COR_F_DW-1:0]			f_res_postRnd;
	logic	[LAMP_FLOAT_COR_E_DW-1:0]			e_res_postRnd;
	logic	[LAMP_FLOAT_COR_DW-1:0]			    res_postRnd;
...
//////////////////////////////////////////////////////////////////
	...
	always_comb
	begin
		{s_op1_wire, e_op1_wire, f_op1_wire}										= FUNC_COR_splitOperand(op1_i);
		{isInf_op1_wire,isDN_op1_wire,isZ_op1_wire,isSNAN_op1_wire,isQNAN_op1_wire}	= FUNC_COR_checkOperand(op1_i);
		extE_op1_wire																= FUNC_COR_extendExp(e_op1_wire, isDN_op1_wire);
		extF_op1_wire 																= FUNC_COR_extendFrac(f_op1_wire, isDN_op1_wire, isZ_op1_wire);

		{s_op2_wire, e_op2_wire, f_op2_wire}										= FUNC_COR_splitOperand(op2_i);
		{isInf_op2_wire,isDN_op2_wire,isZ_op2_wire,isSNAN_op2_wire,isQNAN_op2_wire}	= FUNC_COR_checkOperand(op2_i);
		extE_op2_wire																= FUNC_COR_extendExp(e_op2_wire, isDN_op2_wire);
		extF_op2_wire 																= FUNC_COR_extendFrac(f_op2_wire, isDN_op2_wire, isZ_op2_wire);

		//	mul/div only
		nlz_op1_wire																= FUNC_COR_numLeadingZeros(extF_op1_wire);
		nlz_op2_wire																= FUNC_COR_numLeadingZeros(extF_op2_wire);
...
//////////////////////////////////////////////////////////////////
	...
	begin
		if (rndMode_r == FPU_RNDMODE_NEAREST)
			f_res_postRnd	= FUNC_COR_rndToNearestEven(f_res);
		else
			f_res_postRnd	= f_res[3+:LAMP_FLOAT_COR_F_DW];
		if (isToRound)
			res_postRnd		= {s_res, e_res, f_res_postRnd};
		else
			res_postRnd		= {s_res, e_res, f_res[5+:LAMP_FLOAT_COR_F_DW]};
	end
