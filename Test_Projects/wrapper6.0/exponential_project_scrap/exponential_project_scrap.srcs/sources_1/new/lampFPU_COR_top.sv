...
// OUTPUT wires: to drive registered output
	...
	//	add/sub outputs
	logic									addsub_s_res;
	logic	[LAMP_FLOAT_COR_E_DW-1:0]			addsub_e_res;
	logic	[LAMP_FLOAT_COR_F_DW+5-1:0]			addsub_f_res;
	logic									addsub_valid;
	...
	//	add/sub only
	logic									op1_GT_op2_r;
	logic	[LAMP_FLOAT_COR_E_DW+1-1 : 0] 		e_diff_r;
	...
	logic	[LAMP_FLOAT_COR_E_DW+1-1 : 0] 		e_diff_wire;
...
//////////////////////////////////////////////////////////////////
	...
	begin
		...
		//	add/sub only
		op1_GT_op2_wire																= FUNC_COR_op1_GT_op2(extF_op1_wire, extE_op1_wire, extF_op2_wire, extE_op2_wire);
