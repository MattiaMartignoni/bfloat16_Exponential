...
with open('C:/Users/matti/Desktop/TEST/BIT_ANALYSIS/20_bit/data_file.csv','r') as csvfile:
...
with open('C:/Users/matti/Desktop/TEST/BIT_ANALYSIS/20_bit/err_perc.csv','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
    for row in plots:
        #y.append(float(row[0]))
