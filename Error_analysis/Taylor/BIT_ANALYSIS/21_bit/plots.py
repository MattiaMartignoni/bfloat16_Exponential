...
with open('C:/Coding_Projects/ES_project/REPOSITORY/Error_analysis/Taylor/BIT_ANALYSIS/21_bit/data_file.csv','r') as csvfile:
...
with open('C:/Coding_Projects/ES_project/REPOSITORY/Error_analysis/Taylor/BIT_ANALYSIS/21_bit/err_perc.csv','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
    for row in plots:
        #y.append(float(row[0]))
...
plt.xlabel('x (input value)')
plt.ylabel('y (absolute value of percentage error)')
#plt.title('percentage error vs. iteration (21 bits)')
plt.legend()
plt.show()
