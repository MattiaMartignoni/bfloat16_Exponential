...
with open('C:/Coding_Projects/ES_project/REPOSITORY/Error_analysis/Taylor/22_bit/data_file.csv','r') as csvfile:
...
with open('C:/Coding_Projects/ES_project/REPOSITORY/Error_analysis/Taylor/22_bit/err_perc.csv','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
    for row in plots:
        #y.append(float(row[0]))
