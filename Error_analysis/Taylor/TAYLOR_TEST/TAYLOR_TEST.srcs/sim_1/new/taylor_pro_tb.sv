...
module taylor_pro_tb();
    ...
    int data_file;
    int err_perc_file;
    string diff_bits_file_path  = "C:/Coding_Projects/ES_project/REPOSITORY/Error_analysis/Taylor/BIT_ANALYSIS/17_bit/diff_bits.csv";
    string data_file_path       = "C:/Coding_Projects/ES_project/REPOSITORY/Error_analysis/Taylor/BIT_ANALYSIS/17_bit/data_file.csv";
    string err_perc_file_path   = "C:/Coding_Projects/ES_project/REPOSITORY/Error_analysis/Taylor/BIT_ANALYSIS/17_bit/err_perc.csv";
