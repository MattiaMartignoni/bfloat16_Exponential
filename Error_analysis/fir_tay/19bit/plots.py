...
with open('C:/Coding_Projects/ES_project/REPOSITORY/Error_analysis/fir_tay/19bit/data_file.csv','r') as csvfile:
...
with open('C:/Coding_Projects/ES_project/REPOSITORY/Error_analysis/fir_tay/19bit/err_perc.csv','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
    for row in plots:
        #y.append(float(row[0]))
...
plt.xlabel('x (input value)')
plt.ylabel('y (absolute value of percentage error)')
#plt.title('percentage error vs. iteration (n bits)')
plt.legend()
plt.show()
