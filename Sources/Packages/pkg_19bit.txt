...
package lampFPU_XXX_pkg;
	...
	parameter LAMP_FLOAT_DW		=	19;
	parameter LAMP_FLOAT_S_DW 	=	1;
	parameter LAMP_FLOAT_E_DW 	=	8;
	parameter LAMP_FLOAT_F_DW 	=	10;
	...
	const logic [LAMP_FLOAT_DW-1:0] X0 = 19'b0__0111_1111__0011_0100_10; //should be 1.20513635844646... and is rounded to 1.205078125 to use only 10 bits (reciproco)
	const logic [LAMP_FLOAT_DW-1:0] Y0 = 19'b0__0000_0000__0000_0000_00;
	const logic [LAMP_FLOAT_DW-1:0] Z0 = 19'b0__0000_0000__0000_0000_00;
	const logic 										D0 = 1'b0;
	...
	const logic [LAMP_FLOAT_DW-1:0] ONE_CONST = 19'b0_0111_1111_0000_0000_00;

	parameter INF				 =	18'b1111_1111__0000_0000_00;
	parameter ZERO				=	18'b0000_0000__0000_0000_00;
	parameter SNAN				=	18'b1111_1111__0111_1111_11;
	parameter QNAN				=	18'b1111_1111__1000_0000_00;
	...
	parameter INF_E_F				=	18'b111111110000000000; // w/o sign
	parameter SNAN_E_F			=	18'b111111110111111111; // w/o sign
	parameter QNAN_E_F			=	18'b111111111000000000; // w/o sign
	parameter ZERO_E_F			=	18'b000000000000000000; // w/o sign
	...
	function automatic logic FUNC_op1_GT_op2(
		...
		function automatic logic [LAMP_FLOAT_DW-1:0] FUNC_lut_factorial(input [2:0] counter);
			...
			case (counter)
				3'd0 : return 'b0__0111_1110__0000_0000_00; //1/(2!)= 1/2=    0,5
				3'd1 : return 'b0__0111_1100__0101_0101_01; //1/(3!)= 1/6=    0.166666...  approx 0.166687011719
				3'd2 : return 'b0__0111_1010__0101_0101_01; //1/(4!)= 1/24=   0.041666...  approx 0.0416717529297
				3'd3 : return 'b0__0111_1000__0001_0001_00; //1/(5!)= 1/120=  0.008333...  approx 0.00833511352539
				3'd4 : return 'b0__0111_0101__0110_1100_00; //1/(6!)= 1/720=  0.001388...  approx 0.00138902664185
				3'd5 : return 'b0__0111_0010__1010_0000_00; //1/(7!)= 1/5040= 0.0001984127 approx 0.000198423862457
				default : return 'b0__0000_0000__0000_0000_00;
			endcase
  ...
  function automatic logic [LAMP_FLOAT_DW-1:0] FUNC_lut_arctanh(input [4:0] counter);
      ...
      case(counter)
          5'd0  : return 'b0__0111_1110__0001_1001_01; //arctanh(1/2)       = 0.54930614433405 --- approx ---> 0.54931640625
          5'd1  : return 'b0__0111_1101__0000_0101_10; //arctanh(1/4)       = 0.25541281188299 --- approx ---> 0.25537109375
          5'd2  : return 'b0__0111_1100__0000_0001_10; //arctanh(1/8)       = 0.12565721414045 --- approx ---> 0.125732421875
          5'd3  : return 'b0__0111_1011__0000_0000_01; //arctanh(1/16)      = 0.06258157147700 --- approx ---> 0.0625610351562
          5'd4  : return 'b0__0111_1010__0000_0000_00; //arctanh(1/32)      = 0.03126017849066 --- approx ---> 0.0312652587891
          5'd5  : return 'b0__0111_1001__0000_0000_00; //arctanh(1/64)      = 0.01562627175205 --- approx ---> 0.015625
          5'd6  : return 'b0__0111_1000__0000_0000_00; //arctanh(1/128)     = 0.00781265895154 --- approx ---> 0.0078125
          5'd7  : return 'b0__0111_0111__0000_0000_00; //arctanh(1/256)     = 0.00390626986839 --- approx ---> 0.00390625
          5'd8  : return 'b0__0111_0110__0000_0000_00; //arctanh(1/512)     = 0.00195312748353 --- approx ---> 0.001953125
          5'd9  : return 'b0__0111_0101__0000_0000_00; //arctanh(1/1024)    = 0.00097656281044 --- approx ---> 0.0009765625
          5'd10 : return 'b0__0111_0100__0000_0000_00; //arctanh(1/2048)    = 0.00048828128881 --- approx ---> 0.00048828125
          5'd11 : return 'b0__0111_0011__0000_0000_00; //arctanh(1/4096)    = 0.00024414062985 --- approx ---> 0.000244140625
          5'd12 : return 'b0__0111_0010__0000_0000_00; //arctanh(1/8192)    = 0.00012207031311 --- approx ---> 0.0001220703125
          5'd13 : return 'b0__0111_0001__0000_0000_00; //arctanh(1/16384)   = 0.00006103515633 --- approx ---> 0.00006103515625
          5'd14 : return 'b0__0111_0000__0000_0000_00; //arctanh(1/32768)   = 0.00003051757813 --- approx ---> 0.000030517578125
          5'd15 : return 'b0__0110_1111__0000_0000_00; //arctanh(1/65536)   = 0.00001525878906 --- approx ---> 0.0000152587890625
          5'd16 : return 'b0__0110_1110__0000_0000_00; //arctanh(1/131072)  = 0.00000762939453 --- approx ---> 0.00000762939453125
          5'd17 : return 'b0__0110_1101__0000_0000_00; //arctanh(1/262144)  = 0.00000381469765 --- approx ---> 0.000003814697265625
          5'd18 : return 'b0__0110_1100__0000_0000_00; //arctanh(1/524288)  = 0.00000190734863 --- approx ---> 0.0000019073486328125
          5'd19 : return 'b0__0110_1011__0000_0000_00; //arctanh(1/1048576) = 0.00000095367432 --- approx ---> 0.00000095367431640625
          default : return 'b0__0000_0000__0000_0000_00;
      endcase
	...
	function automatic logic [$clog2(1+1+LAMP_FLOAT_F_DW+3)-1:0] FUNC_AddSubPostNorm_numLeadingZeros( input [1+1+LAMP_FLOAT_F_DW+3-1:0] f_initial_res);
		...
		casez(f_initial_res)
			...
			15'b0001???????????: return  'd2;
			15'b00001??????????: return  'd3;
			15'b000001?????????: return  'd4;
			15'b0000001????????: return  'd5;
			15'b00000001???????: return  'd6;
			15'b000000001??????: return  'd7;
			15'b0000000001?????: return  'd8;
			15'b00000000001????: return  'd9;
			15'b000000000001???: return  'd10;
			15'b0000000000001??: return  'd11;
			15'b00000000000001?: return  'd12;
			15'b000000000000001: return  'd13;
	...
	function automatic logic [$clog2(LAMP_FLOAT_F_DW+1)-1:0] FUNC_numLeadingZeros(
				    ...
				    casez(f_i)
				      ...
				      11'b0001???????: return 'd3;
				      11'b00001??????: return 'd4;
				      11'b000001?????: return 'd5;
				      11'b0000001????: return 'd6;
				      11'b00000001???: return 'd7;
							11'b000000001??: return 'd8;
							11'b0000000001?: return 'd9;
							11'b00000000001: return 'd10;
				      11'b00000000000: return 'd0; // zero result
    				endcase
	endfunction
