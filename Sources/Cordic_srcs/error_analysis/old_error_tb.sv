...
module cordic_exp_module_tb();
    ...
    int data_file;
    int err_perc_file;
    string diff_bits_file_path = "C:/Coding_Projects/ES_project/PROJECTS_FOR_TESTS/Test_files_20/diff_bits.csv";
    string data_file_path = "C:/Coding_Projects/ES_project/PROJECTS_FOR_TESTS/Test_files_20/data_file.csv";
    string err_perc_file_path = "C:/Coding_Projects/ES_project/PROJECTS_FOR_TESTS/Test_files_20/err_perc.csv";
                ...
                begin
                    ...
                    begin
                        case(LAMP_FLOAT_DW)
                            16:
                            begin
                                correct_result = e**$bitstoshortreal({data_i, 16'b0});
                                ...
                                correct_result_rounded = {correct_result_bits[31:23], correct_result_f_rounded};

                                //------------------------------------------16 BIT ROUNDING
                                result_to_round_16 = {1'b0, 1'b1, correct_result_bits[22:14], | correct_result_bits[13:0]};
                                correct_result_f_rounded_16 = FUNC_rndToNearestEven_16(result_to_round_16);
                                correct_result_rounded_16 = {correct_result_bits[31:23], correct_result_f_rounded_16};

                                data_o_rounded_16 = data_o; //data_o is already 16 bit wide

                                data_o_real = $bitstoshortreal({data_o, 16'b0});
                            end
                            18:
                            begin
                                correct_result = e**$bitstoshortreal({data_i, 14'b0});
                                correct_result_bits = $shortrealtobits(correct_result);

                                //------------------------------------------18 BIT ROUNDING
                                result_to_round = {1'b0, 1'b1, correct_result_bits[22:12], | correct_result_bits[11:0]};
                                correct_result_f_rounded = FUNC_rndToNearestEven(result_to_round);
                                correct_result_rounded = {correct_result_bits[31:23], correct_result_f_rounded};
                                ...
                                data_o_to_round_16 = {1'b0, 1'b1, data_o[8:0], 1'b0};
                                data_o_mantissa_rounded_16 = FUNC_rndToNearestEven_16(data_o_to_round_16);
                                data_o_rounded_16 = {data_o[17:9], data_o_mantissa_rounded_16};

                                data_o_real = $bitstoshortreal({data_o, 14'b0});
                            end
                            19:
                            begin
                                correct_result = e**$bitstoshortreal({data_i, 13'b0});
                                correct_result_bits = $shortrealtobits(correct_result);

                                //------------------------------------------19 BIT ROUNDING
                                result_to_round = {1'b0, 1'b1, correct_result_bits[22:11], | correct_result_bits[10:0]};
                                correct_result_f_rounded = FUNC_rndToNearestEven(result_to_round);
                                correct_result_rounded = {correct_result_bits[31:23], correct_result_f_rounded};
                                ...
                                data_o_to_round_16 = {1'b0, 1'b1, data_o[9:0]};
                                data_o_mantissa_rounded_16 = FUNC_rndToNearestEven_16(data_o_to_round_16);
                                data_o_rounded_16 = {data_o[18:10], data_o_mantissa_rounded_16};

                                data_o_real = $bitstoshortreal({data_o, 13'b0});
                            end
                            20:
                            begin
                                correct_result = e**$bitstoshortreal({data_i, 12'b0});
                                correct_result_bits = $shortrealtobits(correct_result);

                                //------------------------------------------20 BIT ROUNDING
                                result_to_round = {1'b0, 1'b1, correct_result_bits[22:10], | correct_result_bits[9:0]};
                                correct_result_f_rounded = FUNC_rndToNearestEven(result_to_round);
                                correct_result_rounded = {correct_result_bits[31:23], correct_result_f_rounded};
                                ...
                                data_o_to_round_16 = {1'b0, 1'b1, data_o[10:2], | data_o[1:0]};
                                data_o_mantissa_rounded_16 = FUNC_rndToNearestEven_16(data_o_to_round_16);
                                data_o_rounded_16 = {data_o[19:11], data_o_mantissa_rounded_16};

                                data_o_real = $bitstoshortreal({data_o, 12'b0});
                            end
                            21:
                            begin
                                correct_result = e**$bitstoshortreal({data_i, 11'b0});
                                correct_result_bits = $shortrealtobits(correct_result);

                                //------------------------------------------21 BIT ROUNDING
                                result_to_round = {1'b0, 1'b1, correct_result_bits[22:9], | correct_result_bits[8:0]};
                                correct_result_f_rounded = FUNC_rndToNearestEven(result_to_round);
                                correct_result_rounded = {correct_result_bits[31:23], correct_result_f_rounded};
                                ...
                                data_o_to_round_16 = {1'b0, 1'b1, data_o[11:3], | data_o[2:0]};
                                data_o_mantissa_rounded_16 = FUNC_rndToNearestEven_16(data_o_to_round_16);
                                data_o_rounded_16 = {data_o[20:12], data_o_mantissa_rounded_16};

                                data_o_real = $bitstoshortreal({data_o, 11'b0});
                            end
                        endcase
                        ...
                        err_perc_16 = (correct_result_rounded_real_16-data_o_real_16)/correct_result_rounded_real_16*100;
