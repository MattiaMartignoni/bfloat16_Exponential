    ...
    begin
        ...
        case (state)
            ...
            begin
                ...
                if (isReady)
                begin
                    op1 <=    16'b1__0111_1011__0001_1110000; //-0.06982421875
                    op2 <=    16'b0__0111_1011__1001_1000000; //0.099609375
            ...
            begin
                ...
                if (isReady)
                begin
                    op1 <=    16'b0__1000_0010__0110_0000000; //11
                    op2 <=    16'b0__0111_1111__0111_0010000; //1.4453125
                    rndMode <= FPU_RNDMODE_NEAREST;
                    opcode <= FPU_MUL;
