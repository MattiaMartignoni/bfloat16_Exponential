...
HD_PWD='C:/Coding_Projects/ES_project/REPOSITORY/Final/FINAL_PROJECT/bfloat16_exponential_test/bfloat16_exponential_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exponential_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exponential_top.tcl
