package exponential_pkg_scrap;
	...
	parameter LAMP_FLOAT_MUL_DW	  = 24; //AVAILABLE OPTIONS: 20-26 CHANGE ALSO THE MARKED SECTION!!!
	...
	parameter LAMP_FLOAT_TAY_DW	  = 21; //AVAILABLE OPTIONS: 16, 20-26 CHANGE ALSO THE MARKED SECTION!!!
